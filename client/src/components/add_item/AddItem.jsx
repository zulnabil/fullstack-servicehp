...
import MaterialUIPickers from './subcomponents/DatePicker'
...
const color = [
  'Black', 'White', 'Red', 'Blue', 'Grey', 'Gold', 'Rose Gold', 'Yellow'
];
...
function AddItem() {
  ...
  function handleSubmit() {
    if (validateForm()) {
      ...
      setDuration(10000)
      axios.post('https://us-central1-uniq-servishp.cloudfunctions.net/app/api/add', values)
        .then(res => {
  ...
  return (
    <div>
      <form className={classes.container} noValidate autoComplete="off">
        <Typography className={classes.title} >New Check-in Form</Typography>
        <TextField
          id="standard-name"
          label="Name Owner"
